...
To obtain the corollary, map approximation of \(x^k\) on \([0,1]\) by degree \(b\) polynomials to approximation of \(x^{2k}\) on \([-1,1]\) by degree \(2b\) polynomials. Theorem 3 of \citet{newman1976} bounds that error between \(T_{b,k}/(4e)\) and \(T_{b,k}\). The \(b^2\) approximation transition is theirs. Its interpretation as the exact pass@\(k\) ambiguity is new here.
